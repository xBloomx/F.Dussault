import{t as e}from"./supabase-BHP_DPH_.js";import{r as t,t as n}from"./auth-BoJf8KxA.js";function r(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`):``}function i(e){if(!e||typeof e!=`string`)return`#`;try{let t=new URL(e);return[`https:`,`http:`].includes(t.protocol)?e:`#`}catch{return`#`}}var a=``,o=`Moi`,s=new Set,c=[],l=[],u=null,d=null,f=null,p=!1,m=0,h=null,g=null,_=null,v=null,y=null,b=null,x=JSON.parse(localStorage.getItem(`dussault_quick_reacts`))||[`❤️`,`👍`,`😂`,`😮`,`😢`,`🙏`],S={global:{name:`Équipe (Général)`,isGroup:!0,messages:[]}},C=40,w=140,T=80,ee=500;async function te(e){return a=t?.id||``,o=n?.prenom_nom||t?.email?.split(`@`)[0]||`Moi`,e.innerHTML=`
    <style>
