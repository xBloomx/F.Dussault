...
export async function render(container) {
    ...
    <style>
        ...
        .btn-new-quote-full { width: 100%; background: var(--accent); color: black; border: none; padding: 14px 20px; border-radius: 50px; font-weight: bold; font-size: 16px; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px; transition: 0.2s; box-shadow: 0 4px 6px rgba(0,0,0,0.3); }
        .btn-new-quote-full:hover { background: var(--accent-hover); transform: translateY(-1px); }
        .btn-new-quote-full svg { width: 18px; height: 18px; stroke: currentColor; fill: none; stroke-width: 2.5; }
    ...
    <div class="soum-main">
        <div id="view-dashboard">
            ...
            <button class="btn-new-quote-full" id="btnNewQuote">
