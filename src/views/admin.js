...
export async function render(container) {
    ...
    <style>
        ...
        * { -ms-overflow-style: none; scrollbar-width: none; }
        ...
        @media (max-width: 768px) { .admin-main { padding: 30px 15px 15px 15px; } .dash-title { padding-right: 80px; } .tabs-container { margin-right: 0; } .settings-grid { grid-template-columns: 1fr; } .admin-danger-row { flex-direction: column; } .admin-danger-row .settings-card { min-width: 0 !important; flex: none !important; width: 100%; } }
    </style>
